...
class HeatmapSettingsService {
  ...
  Map<String, dynamic> _getDefaultSettings() {
    return {
      ...
      'weight_medium': 0.5,
      'weight_low': 0.25,
      'radius_critical_base': 400.0,
      'radius_critical_min': 500.0,
      'radius_critical_max': 2500.0,
      'radius_critical_count_multiplier': 30.0,
      'radius_critical_intensity_multiplier': 80.0,
      'radius_high_base': 300.0,
      'radius_high_min': 400.0,
      'radius_high_max': 1800.0,
      'radius_high_count_multiplier': 25.0,
      'radius_high_intensity_multiplier': 60.0,
      'radius_medium_base': 250.0,
      'radius_medium_min': 300.0,
      'radius_medium_max': 1200.0,
      'radius_medium_count_multiplier': 20.0,
      'radius_medium_intensity_multiplier': 50.0,
      'radius_low_base': 200.0,
      'radius_low_min': 250.0,
      'radius_low_max': 800.0,
      'radius_low_count_multiplier': 15.0,
      'radius_low_intensity_multiplier': 40.0,
    };
  }
