...
class HeatmapSettingsService {
  ...
  Map<String, dynamic> _getDefaultSettings() {
    return {
      'cluster_merge_distance': 20.0,
      'min_crimes_for_cluster': 3,
      'proximity_alert_distance': 250.0,
      ...
      'weight_medium': 0.5,
      'weight_low': 0.25,
      'radius_critical_base': 100.0,
      'radius_critical_min': 150.0,
      'radius_critical_max': 440.0,
      'radius_critical_count_multiplier': 10.0,
      'radius_critical_intensity_multiplier': 30.0,
      'radius_high_base': 80.0,
      'radius_high_min': 100.0,
      'radius_high_max': 320.0,
      'radius_high_count_multiplier': 8.0,
      'radius_high_intensity_multiplier': 22.0,
      'radius_medium_base': 60.0,
      'radius_medium_min': 80.0,
      'radius_medium_max': 220.0,
      'radius_medium_count_multiplier': 6.0,
      'radius_medium_intensity_multiplier': 17.0,
      'radius_low_base': 40.0,
      'radius_low_min': 60.0,
      'radius_low_max': 150.0,
      'radius_low_count_multiplier': 4.0,
      'radius_low_intensity_multiplier': 14.0,
    };
  }
