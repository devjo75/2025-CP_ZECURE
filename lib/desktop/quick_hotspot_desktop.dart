...
class HotspotQuickAccessDesktopWidgets {
  ...
  static Widget _buildHotspotCard({
    ...
    final fullLocation = '${hotspotLocation.latitude}, ${hotspotLocation.longitude}';
...
Expanded(
  child: ElevatedButton.icon(
    onPressed: () {
      ...
      _showDirectionsConfirmation(context, hotspotLocation, () {
        onNavigateToHotspot(hotspot);
      }, isSidebarVisible: isSidebarVisible); // Remove hardcoded true
    },
